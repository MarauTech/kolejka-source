...
const apk = `${repo}/releases/download/v1.0.0-beta.2/kolejka-1.0.0-beta.2.apk`;
export default function Home() {
  return <main>
    ...
    <section className="hero shell">
      ...
      <a className={`${buttonVariants({size:'lg'})} download`} href={apk}><Download size={21}/> Pobierz na Androida</a><p className="release-meta">1.0.0-beta.2 · plik APK · bez konta</p><a className="text-link" href="#instalacja">Jak zainstalować aplikację? <span>↓</span></a></div>
      <aside className="release-panel" aria-label="Informacje o wydaniu"><div className="panel-top"><span>KOLEJKA / ANDROID</span><span className="status-dot">WERSJA TESTOWA</span></div><Image unoptimized className="app-icon" src={`${basePath}/kolejka.png`} width="160" height="160" alt="Logo aplikacji Kolejka"/><div className="panel-title">Następny przystanek:<br/><strong>Twoja podróż.</strong></div><div className="panel-bottom"><span>WYDANIE <b>02 / BETA</b></span><a href={`${repo}/releases/tag/v1.0.0-beta.2`}>Co nowego <ArrowUpRight size={17}/></a></div></aside>
    </section>
